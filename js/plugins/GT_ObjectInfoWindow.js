...
Window_ObjectInfo.prototype.processDrawIcon = function (iconIndex, textState) {
	...
	textState.x += Math.round((Window_Base._iconWidth + 4) * this.scaleRate());
};
...
Window_ObjectInfo.prototype.calculateTitleWidth = function () {
	...
	width += eval(this._windowSet.ShowBigIcon) ? this.titleHeight() : (Window_Base._iconWidth + 15) * this.scaleRate();
